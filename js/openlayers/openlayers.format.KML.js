...
OpenLayers.Format.KML = OpenLayers.Class(OpenLayers.Format.XML, {
	...
	/**
     * Property: groundoverlay
     * {Array} Array of groundoverlays <Object>  
     *     
     */
    groundoverlays: [],
    ...
    parseData: function(data, options) {
        ...
        for(var i=0, len=types.length; i<len; ++i) {
            ...
            switch (type.toLowerCase()) {
				...
				//parse groundoverlay
				case "groundoverlay":
					this.parseGroundoverlay(nodes, options);
					break;
            }
        }
	...
	/**
     * Method: parseGroundoverlay
     * Loop through all groundoverlay nodes and parse them.
     * Will create a list of features
     * 
     * Parameters: 
     * nodes    - {Array} of {DOMElement} data to read/parse.
     ...
     * 
     */
    parseGroundoverlay: function(nodes, options) {
		var node, me=this;
		for(var i=0, len=nodes.length; i<len; i++) {
            node=nodes[i];
			this.groundoverlays.push({
				name: me.getElementsByTagNameNS(node, "*", "name")[0].firstChild.nodeValue,
				description: me.getElementsByTagNameNS(node, "*", "description")[0].firstChild.nodeValue,
				visibility: me.getElementsByTagNameNS(node, "*", "visibility")[0].firstChild.nodeValue,
				href: (function(){
					var icon=me.getElementsByTagNameNS(node, "*", "Icon")[0];
					return me.getElementsByTagNameNS(icon, "*", "href")[0].firstChild.nodeValue;
				})(),
				bonuds: (function(){
					var latlngbox=me.getElementsByTagNameNS(node, "*", "LatLonBox")[0];
					return new OpenLayers.Bounds(me.getElementsByTagNameNS(latlngbox, "*", "west")[0].firstChild.nodeValue, me.getElementsByTagNameNS(latlngbox, "*", "south")[0].firstChild.nodeValue, me.getElementsByTagNameNS(latlngbox, "*", "east")[0].firstChild.nodeValue, me.getElementsByTagNameNS(latlngbox, "*", "north")[0].firstChild.nodeValue)
				})()
			});
        }
	},
